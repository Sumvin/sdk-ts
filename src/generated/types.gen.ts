 ...
 */
export type SigilPublicData = {
    /**
     * Sri
     *
     * Sumvin identifier of the account the Sigil belongs to, exactly as stored. The Sigil's pattern is generated from this string, so draw from this value rather than from the one in the request path.
     */
    sri: string;
    /**
     * Sigil Rank
     *
     * This Sigil's place among the first 1000 issued at launch. Null for a Sigil outside them, or one issued before launch or to a Sumvin team account.
     */
    sigil_rank?: number | null;
    /**
     * Minted At
     *
     * When the Sigil was issued, in epoch milliseconds.
     */
 ...
 */
export type SigilPublicResponse = {
    /**
     * Links
     *
     * HAL-style hypermedia links for navigation and available actions.
    ...
    /**
     * The Sigil, public view.
     */
    sigil: SigilPublicData;
};
...
export type GetPublicSigilData = {
    body?: never;
    headers?: {
        /**
         * Controls how timestamp fields are serialized in JSON response bodies.
    ...
    query?: never;
    url: '/v0/sigils/public/{sri}';
};

export type GetPublicSigilErrors = {
    /**
     * Bad Request
     */
    400: ProblemDetail;
...
export type GetPublicSigilError = GetPublicSigilErrors[keyof GetPublicSigilErrors];

export type GetPublicSigilResponses = {
    /**
     * Successful Response
     */
    200: SigilPublicResponse;
};

export type GetPublicSigilResponse = GetPublicSigilResponses[keyof GetPublicSigilResponses];
